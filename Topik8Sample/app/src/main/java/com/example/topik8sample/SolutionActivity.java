...
public class SolutionActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData("http://172.30.1.13:5000/topik1_solution/"); // visual code 상에서 구현
        ...
        Request request = new Request.Builder().url("http://172.30.1.13:5000/topik1_solution/").post(formbody).build();
