...
public class ProblemSet{
    ...
    public ProblemSet(int answer, String choice1, String choice2, String choice3, String choice4, String conversation, String example,
                      String explanation, String hint, String large_category, String level, String mediumcategory, String multiple_question,
                      String music, int prob_num, String question, String section, String set_problem, String small_category, String topic, int year) {
        this.answer = answer;
    ...
    public String getMultiple_question() {
        return multiple_question;
    }

    public void setMultiple_question(String multiple_question) {
        this.multiple_question = multiple_question;
    }
